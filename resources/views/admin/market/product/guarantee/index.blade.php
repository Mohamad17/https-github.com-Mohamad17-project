    ...
    <div class="col-md-12 mt-4">
        <div class="content">
            ...
            <div class="d-flex justify-content-between align-items-center my-3">
                <a href="{{ route('admin.market.product.guarantee.create', $product->id) }}" class="btn btn-info btn-sm">ایجاد گارانتی چدید</a>
                        ...
                        @foreach ($product->guarantees as $guarantee)
                            <tr>
                                ...
                                <td class="width-16rem">
                                    <a href="{{ route('admin.market.product.guarantee.edit',[$guarantee->id]) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit mx-1"></i>ویرایش</a>
                                    <form class="d-inline" action="{{ route('admin.market.product.guarantee.destroy',[$guarantee->id]) }}" method="POST">
                                        @csrf
                                        {{ method_field('delete') }}
