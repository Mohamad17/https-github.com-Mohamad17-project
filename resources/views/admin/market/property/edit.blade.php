...
@section('content')
    ...
    <div class="col-md-12 mt-4">
        <div class="content">
            ...
            <form class="row" action="{{ route('admin.market.property.update', $property->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="col-md-6 mb-2">
                    <fieldset class="form-group">
                        <label for="name">نام فرم محصول</label>
                        <input class="form-control form-control-sm" value="{{ old('unit', $property->name) }}" name="name" type="text" placeholder="نام ...">
                    </fieldset>
                    @error('name')
                ...
                <div class="col-md-6 mb-2">
                    <fieldset class="form-group">
                        ...
                        <input class="form-control form-control-sm" value="{{ old('unit', $property->unit) }}" name="unit" type="text"
