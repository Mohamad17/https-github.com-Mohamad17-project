...
<div class="col-md-12 mt-4">
    <div class="content">
        ...
        <form class="row" action="{{ route('admin.ticket.priority.store') }}" method="post">
            @csrf
            <div class="col-md-6 mb-2">
                <fieldset class="form-group">
                    <label for="name">عنوان اولویت تیکت</label>
                    <input class="form-control form-control-sm" value="{{ old('name') }}" name="name" type="text" placeholder="عنوان اولویت تیکت ...">
                </fieldset>
                @error('name')
