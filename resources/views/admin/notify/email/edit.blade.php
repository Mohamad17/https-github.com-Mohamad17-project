...
<div class="col-md-12 mt-4">
    <div class="content">
        ...
        <form class="row" action="{{ route('admin.notify.email.update', [$email->id]) }}" method="post">
            @csrf
            {{ method_field('put') }}
            <div class="col-md-6 mb-2">
                <fieldset class="form-group">
                    <label for="title">عنوان ایمیل</label>
                    <input class="form-control form-control-sm" value="{{ old('subject',$email->subject) }}" name="subject" type="text" placeholder="عنوان ایمیل ...">
                </fieldset>
                @error('title')
            ...
            <div class="col-md-6 mb-2">
                <fieldset class="form-group">
                    ...
                    <input class="form-control form-control-sm d-none" value="{{ old('published_at',$email->published_at) }}" name="published_at" id="published_at" type="text" placeholder="تاریخ انتشار ...">
                    <input class="form-control form-control-sm" value="{{ old('published_at',$email->published_at) }}" id="published_at_view" type="text" placeholder="تاریخ انتشار ...">
                </fieldset>
                @error('published_at')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
            ...
            <div class="col-12 mb-2">
                <fieldset class="form-group">
                    ...
                    <textarea class="form-control form-control-sm" id="body" name="body" cols="6"> {{ old('body',$email->body) }}</textarea>
                </fieldset>
                @error('body')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
