...
<div class="col-md-12 mt-4">
    <div class="content">
        ...
        <div class="d-flex justify-content-between align-items-center my-3">
            <a href="{{ route('admin.notify.email-files.index', [$file->email->id]) }}" class="btn btn-info btn-sm">بازگشت</a>
        </div>
        <form class="row" action="{{ route('admin.notify.email-files.update', [$file->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            {{ method_field('put') }}
