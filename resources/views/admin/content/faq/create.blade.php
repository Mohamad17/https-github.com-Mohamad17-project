...
@section('content')
    ...
    <div class="col-md-12 mt-4">
        <div class="content">
            ...
            <form class="row" action="{{ route('admin.content.faq.store') }}" method="post">
                @csrf
                <div class="col-md-6 mb-2">
                    <fieldset class="form-group">
                        <label for="question">پرسش</label>
                        <input class="form-control form-control-sm" value="{{ old('question') }}" name="question"
                            type="text" placeholder="پرسش ...">
                    </fieldset>
                    @error('question')
                ...
                <div class="col-12 mb-2">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control form-control-sm" value="{{ old('tags') }}" name="tags"
