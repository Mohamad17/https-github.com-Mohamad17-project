...
<div class="col-md-12 mt-4">
    <div class="content">
        ...
        <form class="row" action="{{ route('admin.content.banner.update',[$banner->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            {{ method_field('put') }}
            <div class="col-md-6 mb-2">
                <fieldset class="form-group">
                    <label for="title">عنوان بنر</label>
                    <input class="form-control form-control-sm" value="{{ old('title', $banner->title) }}" name="title" type="text" placeholder="عنوان بنر ...">
                </fieldset>
                @error('title')
            ...
            <div class="col-md-6 mb-2">
                <fieldset class="form-group">
                    ...
                    <input class="form-control form-control-sm" value="{{ old('url', $banner->url) }}" name="url" type="text" placeholder="آدرس بنر ...">
                </fieldset>
                @error('url')
                <small class="text-danger">{{ $message }}</small>
            @enderror
