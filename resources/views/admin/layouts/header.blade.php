<header class="header fixed-top shadow">
    <div class="row">
        ...
        <div class="col-md-9 d-md-flex justify-content-between d-none bg-white bodyHeader">
            ...
            <div class="leftSection ml-1 ml-md-4 mr-md-0">
                <span class="bell pointer"><sub><i class="fa fa-bell fa-2x"></i></sub><sup class="badge badge-danger mx-1">5</sup></span>
                <div class="notif d-none">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-action">
                            <div class="media">
                                <img src="asset/images/avatar-2.jpg" alt="avatar" class="ml-2 img-notif">
                                <div class="media-body">
                                    <h6 class="title-notif">محمد رحمتی</h6>
                                    <p class="text-notif">این یک متن تستی است</p>
                                    <p class="text-secondary time-notif">39 دقیقه پیش</p>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item list-group-item-action">
                ...
                <span class="message ml-5 pointer"><sub><i class="fa fa-comment fa-2x"></i></sub><sup class="badge badge-danger mx-1">4</sup></span>
                <div class="commentBox mt-1 d-none">
                    <div class="py-2">
                        <input type="text" name="search" placeholder="جستجو" class="form-controller form-control-sm p-1 searchCom">
                    </div>
                        ...
                        <li class="list-group-item list-group-item-action py-0">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body d-flex justify-content-between align-items-center">
                                    <h6>محمد رحمتی</h6>
                                    <div><i class="fa fa-circle text-success smFont"></i></div>
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item list-group-item-action py-0">
                ...
                <span class="userAvatar pointer position-ralative">
