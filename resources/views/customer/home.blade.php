        ...
        <section class="row">
            <section class="col-md-8 pe-md-1 ">
                <section id="slideshow" class="owl-carousel owl-theme">
                    ...
                    <section class="item"><a class="w-100 d-block h-auto text-decoration-none" href="{{ urldecode($slider->url) }}"><img
                        class="w-100 rounded-2 d-block h-auto" src="{{ $slider->image }}" alt="{{ $slider->title }}"></a>
                    </section>
                    @endforeach
                </section>
            </section>
            <section class="col-md-4 ps-md-1 mt-2 mt-md-0">
                ...
                <section class="mb-2"><a href="{{ urldecode($slider->url) }}" class="d-block"><img class="w-100 rounded-2"
                            src="{{ $slider->image }}" alt="{{ $slider->title }}"></a></section>
                @endforeach
            </section>
        </section>
    </section>
                                        ...
                                        <section class="product">
                                            ...
                                            <a class="product-link" href="#">
                                                <section class="product-image">
                                                    <img class="img-fluid" src="{{ asset($product->image['indexArray']['medium']) }}" alt="{{ $product->name }}">
                                                </section>
            ...
            <section class="row py-4">
                ...
                <a class="col-12 col-md-6 mt-2 mt-md-0" href="{{ urldecode($betweenBanner->url) }}">
                    <img class="d-block rounded-2 w-100"
                        src="{{ asset($betweenBanner->image) }}" alt="{{ $betweenBanner->title }}">
                </a>
                @endforeach
            </section>
                        ...
                        <section class="brands dark-owl-nav owl-carousel owl-theme">
                            ...
                            <section class="item">
                                <section class="brand-item">
                                    <a href="#"><img class="rounded-2 img-fluid" src="{{ asset($brand->logo['indexArray']['medium']) }}"
