...
@section('head-tag')
    <title>تکمیل پروفایل / فروشگاه آمازون</title>
@endsection
                ...
                <section class="col">
                    ...
                    <section class="row mt-4">
                        <section class="col-md-9">
                            <form id="profile_completion" action="{{ route('customer.sales-process.completion-profile.update') }}" method="post" class="content-wrapper bg-white p-3 rounded-2 mb-4">
                                @csrf
                                @method('PUT')
                        ...
                        <section class="col-md-3">
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="fw-bolder"><span id="total_price">{{ priceFormat($finalPrice) }}</span> تومان</p>
                                </section>
