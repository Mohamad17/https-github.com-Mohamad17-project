...
class MenuController extends Controller
{
    ...
    public function store(MenuRequest $request)
    {
        $inputs = $request->all();
        Menu::create($inputs);
        return redirect()->route('admin.content.menu.index')->with('swal-success', 'منوی شما با موفقیت اضافه شد');
    }
    ...
    {
        $menu = Menu::where('parent_id', null)->get()->except($menu->id);
    ...
    {
        $menu->delete();
        return back()->with('swal-success', 'منوی شما با موفقیت حذف شد');
    }
